...
class Rocket():
    ...
    def reset(self, state=None):       
        ...
        if state is not None: 
            (self.x, self.xspeed, self.yspeed) = state
...
class LunarLander():
    ...
    def step(self, action):
        ...
        return ((self.rocket.x, self.rocket.y, self.rocket.xspeed, self.rocket.yspeed, self.rocket.fuel), reward, self.game_over)                
    
    def get_state(self):
        return (self.rocket.x, self.rocket.y, self.rocket.xspeed, self.rocket.yspeed, self.rocket.fuel)
